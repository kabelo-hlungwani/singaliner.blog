...
$edit=mysqli_query($conn,"UPDATE blog_category SET category='$heading' where category_id='$id'");  


if($edit){
mysqli_close($conn);

echo '<script>alert(" category updated added.");window.location = "s-category.php";</script>';
...
<body>
    <div class="container shadow-lg" data-aos="fade-down-right" data-aos-duration="900" data-aos-delay="500" style="font-family: Barlow, sans-serif;padding-bottom: 46px;">
        <form method="post" style="margin-top: 50px;">
            ...
            <div class="form-group"><input class="form-control" type="text" value="<?php  $qry=mysqli_query($conn,"SELECT * FROM blog_category where category_id='$id'");
