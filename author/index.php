...
<div class="login-page">
  <div class="login-card">
    ...
    <div class="login-card-top">
      ...
      <div class="login-brand-sub">Admin panel — manage articles, gallery and site content from one place.</div>
    </div>
    ...
    <div class="login-form-panel">
      ...
      <?php if (!empty($loginError)): ?>
        <div style="background:#fee2e2;color:#dc2626;border-radius:10px;padding:10px 16px;font-size:.83rem;margin-bottom:20px;width:100%;">
