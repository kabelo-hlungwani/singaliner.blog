                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p style="font-size: 11px;"><a class="btn btn-success btn-sm" type="link" href="add-category-stories.php?edt=<?php echo $data['admin_id']?>"  style="font-size: 11px;">Add Category</a>&nbsp;&nbsp;</p>
                        </div>
...
if (isset($_GET['page_no']) && $_GET['page_no']!="") {
    ...
    $result_count = mysqli_query($conn,"SELECT COUNT(*) As total_records FROM `blog_category`");
    ...
    $second_last = $total_no_of_pages - 1; // total page minus 1     
         ...
         $result=mysqli_query($conn,"SELECT * from blog_category  LIMIT $offset, $total_records_per_page");
    ...
    <tr style="font-size:12px;">
      ...
      <td><?php echo $rows['category']?></td>
          <td><a class="btn btn-danger btn-sm" href="delete-s.php?edt=<?php echo $rows['category_id']?>" type="button" style="font-size: 11px;">Delete</a></td>
                 <td><a class="btn btn-warning btn-sm" href="edit-s.php?edt=<?php echo $rows['category_id']?>" type="button" style="font-size: 12px;">Edit</a></td>
    </tr>
    <?php
$x++;
