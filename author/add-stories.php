...
echo '<script>alert("data captured.");window.location = "stories.php";</script>';
}
else
{
...
<body>
    <div class="container shadow-lg" data-aos="fade-down-right" data-aos-duration="900" data-aos-delay="500" style="font-family: Barlow, sans-serif;padding-bottom: 46px;">
        <form method="post" enctype="multipart/form-data"  style="margin-top: 50px;">
            ...
            <div class="form-group"><input class="form-control" type="text" required="" name="heading" placeholder="Heading" ></div><label>Upload Image(s)</label>
            <div class="form-group"><input class="form-control-file" name="picture" type="file"></div>
        ...
        while ($rows=mysqli_fetch_array($result)) {
            ...
            <div class="form-group"><textarea class="form-control" name="editor1" placeholder="" rows="14"></textarea></div>
            <div class="form-group"><button class="btn btn-primary btn-block" name="add"type="submit" style="background: var(--gray-dark);border-color: transparent;">send </button></div>
        </form>
        <script>
