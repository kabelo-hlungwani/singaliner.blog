...
<body>
    ...
    <div class="container" style="padding-top: 40px;">
        <h1 style="font-family: Barlow, sans-serif;font-size: 22px;text-align: center;font-weight: normal;">All Stories</h1>
        <div>
            <div class="container">
                ...
                <div class="col">
                    <ul class="list-inline" style="text-align: center;font-size: 15px;font-family: Barlow, sans-serif;">
                     <li class="list-inline-item" style="background: var(--blue);border-radius: 2px;color: rgb(255,255,255);">&nbsp;<a href="#" style="color: rgb(255,255,255);">All</a>&nbsp;</li>
                    <?PHP          
