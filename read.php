...
<head>
    ...
    <title>Article-Singaliner Inc</title><link rel="icon" href="assets/img/singa1 (2).png">
        ...
        <div class="d-flex justify-content-center align-items-center" style="height:inherit;min-height:initial;width:100%;position:absolute;left:0;background-color:rgba(30,41,99,0.53);">
            <div class="d-flex align-items-center order-12" style="height: 200px;padding-top: 176px;">
                <div class="container">
                    ...
                    <h3 class="text-center" data-aos="fade-down-right" data-aos-duration="1000" data-aos-delay="1000" data-aos-once="true" style="color: rgb(242,245,248);padding-top: 0.25em;padding-bottom: 0.25em;font-weight: normal;font-family: Barlow, sans-serif;font-size: 20px;"><span style="text-decoration: underline;">Find more stories</span></h3>
                </div>
            </div>
        </div>
    </div>
    <div class="container" style="padding-top: 93px;">
        <div class="col" style="padding-top: 22px;"><a class="btn btn-primary btn-sm" role="button" style="font-family: Barlow, sans-serif;background: rgb(46,46,46);border-color: transparent;" href="blog.php"><i class="la la-arrow-left"></i>More stories</a></div>
        <div class="col" style="padding-top: 22px;"></div>
        <div class="row">
        ...
        while ($rows=mysqli_fetch_array($result)) {
            ...
            ?>
        <div class="col-md-8">
                <h3 class="text-left" data-aos="fade-down-right" data-aos-duration="1000" data-aos-delay="1000" data-aos-once="true" style="color: rgb(84,84,84);padding-top: 0.25em;padding-bottom: 0.25em;font-weight: normal;font-family: Lora, serif;font-size: 15px;">Author<i class="icon-user"></i> <em><span style="text-decoration: underline;"><?php echo $rows['name'].''.$rows['surname'] ?></span></em> | <?php echo $rows['date']?></h3><img class="img-fluid" src="author/articles/<?php echo $rows['picture']?>" alt="image" style="opacity: 0.72;filter: contrast(138%);">
                <h1 style="text-align: left;font-size: 23px;font-family: Lora, serif;padding-top: 12px;"><span style="text-decoration: underline;"><?php echo $rows['heading']?></span></h1>
                <h3 class="text-left" data-aos="fade-down-right" data-aos-duration="1000" data-aos-delay="1000" data-aos-once="true" style="color: rgb(84,84,84);padding-top: 0.25em;padding-bottom: 0.25em;font-weight: normal;font-family: Barlow, sans-serif;font-size: 12px;"><?php echo $rows['content']?><br></h3>
            ...
            <div class="col-md-4">
                <h1 style="font-size: 20px;font-family: Barlow, sans-serif;font-weight: normal;text-align: left;border-bottom-width: 1px;border-bottom-style: solid;"><i class="icon ion-ios-book" style="font-size: 16px;"></i>&nbsp;More Related Stories</h1>
                <ul class="list-inline" style="font-family: Barlow, sans-serif;font-weight: normal;font-size: 16px;text-align: left;">
                <?PHP          
        ...
        while ($row=mysqli_fetch_array($re)) {
            ...
            ?>
                    ...
                    <li class="list-inline"><a href="read.php?edt=<?php echo $row['article_id']?>" style="color: rgb(80,80,81);"><span class="badge badge-pill badge-dark"><?php echo $x?></span><?php echo $row['heading']?></a></li>
